google.maps.__gjsload__('overlay', function(_) {
    var $ya = function() {},
        ...
        cza = function(a, b) {
            ...
            a.bindTo("panes", f);
            e = () => _.Nq(d.Dg);
            c.Dg = [_.vn(a, "panes_changed", e), _.vn(f, "zoom_changed", e), _.vn(f, "offset_changed", e), _.vn(b, "projection_changed", e), _.vn(f, "projectioncenterq_changed", e)];
            _.Nq(d.Dg);
            b instanceof _.co ? (_.vo(b, "Ox"), _.N(b, 148440)) : b instanceof _.ap && (_.vo(b, "Oxs"), _.N(b, 181451))
        },
        dza = function(a) {
            const b =
                BI(a);
        ...
        iza = function(a) {
            if (a) {
                ...
                if (eza(a) !== b && b && b instanceof _.co) {
                    const c = b.__gm;
                    c.overlayLayer ? a.__gmop = new fza(b, a, c.overlayLayer) : c.Eg.then(({
                        ah: d
                    }) => {
                        const e = new gza(b, d);
                        d.Qi(e);
        ...
        hza = function(a) {
            if (a) {
                ...
                b && (a.__gmop = null, b.overlay.unbindAll(), b.overlay.set("panes",
                    null), b.overlay.set("projection", null), b.overlayLayer.uo(b), b.Dg && (b.Dg = !1, b.overlay.onRemove ? b.overlay.onRemove() : b.overlay.remove()))
            }
        },
        eza = function(a) {
        ...
        bza = class extends _.On {
            ...
            changed(a) {
                a !== "outProjection" && (a = !!(this.get("offset") && this.get("projectionTopLeft") && this.get("projection") && _.mm(this.get("zoom"))),
    ...
    _.Il("overlay", {
        UD: function(a) {
            if (a) {
                ...
                hza(a);
                var b = a.getMap();
                b && (b instanceof _.co ? iza(a) : a && (b = a.getMap(), (BI(a).Hg || null) !== b && (b && cza(a, b), BI(a).Hg = b)))
            }
        },

    ...
    var Fva = {
        ...
        Dva = class {
            ...
            getAnchor() {
                if (!this.anchor) {
                    const a = 1 << this.zoom;
                    this.anchor = _.vs(new _.zr((this.Jn.x * 256 + this.source.a[0]) / a, (this.Jn.y * 256 + this.source.a[1]) / a)).toJSON()
                }
                return this.anchor
            }
            getCompleteBounds() {
                    ...
                    if (!Gva.has(a)) {
                        ...
                        var c = [],
                            ...
                            e = () => {
                                ...
                                b.forEach(f => {
                                    if (f = f.data) c.push(_.vn(f, "insert", g => {
                                        d(g, "addfeatures")
                                    })), c.push(_.vn(f, "remove", g => {
                                        d(g, "removefeatures")
                                    }))
                                })
                            };

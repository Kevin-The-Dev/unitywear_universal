    ...
    var ysb = function(a, b) {
        ...
        Bsb = function(a) {
            if (_.eq[15]) {
                ...
                b && a.Fg && (a.Hg ? (b = b.__gm.Ck, b.set(b.get().ho(a.Fg))) : a.Fg && _.qSa(a.Fg, b) && ((a.Gg || []).forEach(_.Am), a.Gg = null));
                if (c) {
                    b = new _.MA;
                    ...
                    a.Hg ? (a = c.__gm.Ck, a.set(_.Zx(a.get(), b))) : Asb(a, c, b);
                    _.yn(c, "Lg");
                    _.N(c, 148282)
                }
            }
        ...
        Asb = function(a, b, c) {
            ...
            _.PRa(c, _.NS(b));
            b = [];
            b.push(_.ym(c, "click", Dsb.bind(null, a)));
            for (const e of ["mouseover", "mouseout", "mousemove"]) b.push(_.ym(c, e, Esb.bind(null, a, e)));
            b.push(_.ym(a, "clickable_changed", () => {
                a.Fg.clickable = a.get("clickable") !== !1
            }));
            a.Gg = b
        },
        Dsb = function(a, b, c, d, e) {
            let f = null;
            if (e && (f = {
                    status: e.getStatus()
                }, e.getStatus() === 0)) {
        ...
        Csb = class {
            constructor() {
                var a = _.es,
                    b = _.bs;
                this.Fg = _.kk;
                this.fetch = _.oB.bind(Isb, a, _.FD + "/maps/api/js/LayersService.GetFeature", b)
            }
            load(a, b) {
                function c(e) {
                    b(new Hsb(e && e))
                }
                const d = zsb(ysb(new Fsb, a.layerId.split("|")[0]), a.featureId).zi(this.Fg.Gg().Gg());
                for (const e in a.parameters) _.vRa(_.sf(d, 4, _.TS), e).setValue(a.parameters[e]);
                a = _.Hi(d, Gsb());
                this.fetch(a, c, c);
                return a
            }
